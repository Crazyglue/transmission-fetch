...
export default class Transmission {
  ...
  getTransmissionSession(callback) {
    ...
    fetch(...this.compose("POST", this.methods.session.get, {}))
  ...
  getSessionStats(callback) {
    ...
    fetch(...this.compose("POST", this.methods.session.stats, {}))
  ...
  getTorrents(ids = [], callback) {
    ...
    fetch(...this.compose("POST", this.methods.torrents.get, params))
  ...
  startTorrent(ids = [], callback) {
    ...
    fetch(...this.compose("POST", this.methods.torrents.start, params))
  ...
  startTorrentNow(ids = [], callback) {
    ...
    fetch(...this.compose("POST", this.methods.torrents.startNow, params))
  ...
  stopTorrent(ids = [], callback) {
    ...
    fetch(...this.compose("POST", this.methods.torrents.stop, params))
  ...
  addTorrent(filename, params = {}, callback) {
    ...
    fetch(...this.compose("POST", this.methods.torrents.add, params))
      .then((response) => this.checkResponse(response, this.addTorrent.bind(this, filename, params, callback)))
      .then(callback)
  }
